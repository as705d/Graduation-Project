...
def section(filename):
    ...
    binaryvalues = list(filter((0).__ne__, binaryvalues))
    return binaryvalues	      
...
if __name__=="__main__":
	...
	for file in files:
             ...
             #outputFilename=os.path.join("../Challenge_dataset_2020/test_image",base_name)
             outputFilename=os.path.join("../images/10000_Random_unpack",base_name) 
